...
import { Contract, ContractName } from "@/utils";

/**
 * Gets a viem instance of the contract present in deployedContracts.ts or externalContracts.ts corresponding to
 * targetNetworks configured in dapp.config.ts. Optional walletClient can be passed for doing write transactions.
