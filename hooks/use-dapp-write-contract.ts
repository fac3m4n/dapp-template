...
import { ContractAbi, ContractName, DappWriteContractOptions, DappWriteContractVariables, notification } from "@/utils";


/**
 * Wrapper around wagmi's useWriteContract hook which automatically loads (by name) the contract ABI and address from
 * the contracts present in deployedContracts.ts & externalContracts.ts corresponding to targetNetworks configured in dapp.config.ts
 * @param contractName - name of the contract to be written to
 * @param writeContractParams - wagmi's useWriteContract parameters
 */
export const useDappWriteContract = <TContractName extends ContractName>(
